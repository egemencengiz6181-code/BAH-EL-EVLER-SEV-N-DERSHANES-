...
export default async function ServicesPage({
  ...
  const cards = [
    ...
    { slug: '8-sinif',         icon: 'GraduationCap', span: 'md:col-span-1', title: t('items.8-sinif.title'),         description: t('items.8-sinif.description') },
    ...
    { slug: 'mezun',           icon: 'Trophy',        span: 'md:col-span-1', title: t('items.mezun.title'),           description: t('items.mezun.description') },
