...
export default function LocationMap() {
  return (
    <section className="w-full h-[450px] relative overflow-hidden group bg-background">
      <iframe
        src="https://maps.google.com/maps?q=Haznedar+Mah.+Ba%C4%9Fc%C4%B1lar+Caddesi+Bah%C3%A7elievler%2F%C4%B0stanbul&t=&z=16&ie=UTF8&iwloc=&output=embed"
        width="100%"
        height="100%"
        ...
        title="Bahçelievler Sevinç Dershanesi"
      />
      ...
      >
        ...
        <div className="text-slate-900 dark:text-white font-medium">Haznedar Mah. Bağcılar Caddesi</div>
