    ...
    <section className="py-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-10">
        <div className="flex items-center gap-4">
          <div className="h-px flex-1 bg-gradient-to-r from-transparent to-[#E35205]/30" />
          <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#E35205]">
              {t("section_label")}
            </span>
          <div className="h-px flex-1 bg-gradient-to-l from-transparent to-[#E35205]/30" />
        </div>
      </div>
