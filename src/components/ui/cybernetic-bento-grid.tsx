    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 flex items-end justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#E35205] mb-3">
              ✦ {t("section_label")}
            </p>
            <h2 className="text-5xl md:text-6xl font-black tracking-tighter leading-none text-white">
              {t("section_title_1")}
              <br />
              <span className="bg-gradient-to-r from-[#E35205] to-[#A03500] bg-clip-text text-transparent">
                {t("section_title_2")}
              </span>
            </h2>
          </div>
