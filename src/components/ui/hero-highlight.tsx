  ...
  return (
    <span className={cn("relative inline", className)}>
      <motion.span
        ...
        className="absolute inset-0 -z-10 rounded-sm bg-gradient-to-r from-[#E35205]/30 to-[#A03500]/20"
      ...
      <motion.span
        ...
        className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-[#E35205] via-[#FF9E7F] to-[#E35205] rounded-full"
      />
      <span className="relative text-[#FF9E7F]">{children}</span>
    </span>
  );
}
